...
describe("addVertex", function() {
  it("should add a key in the adjacency", function() {
    ...
    expect(graph.vertices.has(c)).toBe(false);
    graph.addVertex(a);
    graph.addVertex(b);
    graph.addVertex(c);
...
describe("removeVertex", function() {
  it("should remove the vertex as well as any edges", function() {
    ...
    expect(graph.vertices.has(a)).toBeTruthy();
    expect(graph.vertices.has(b)).toBeTruthy();
    expect(graph.vertices.has(c)).toBeFalsy();
    expect(graph.vertices.has(d)).toBeFalsy();
  });
});
